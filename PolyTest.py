...
class Test_test1(unittest.TestCase):
    ...
    def test_TypeErrorAdd(self):
        p = Polynomial([0,0,0,-1,0,4,0,-6,9]) 
        s = "gt"
        self.assertRaises(TypeError, Polynomial,p+s)  
        self.assertRaises(TypeError, Polynomial,s+p) 

    def test_TypeErrorMult(self):
        p = Polynomial([0,0,-1,0,4,0,-6]) 
        s = "gty"
        self.assertRaises(TypeError, Polynomial,p*s) 
        self.assertRaises(TypeError, Polynomial,s*p)
